...
packages <- c("readr", "ggplot2", "dplyr", "tidyverse", "skimr", "funModeling", "tibble", "ggpubr", "plotly", "nortest", "caret", "e1071", "pROC", "rpart", "rpart.plot", "ROCR")
...
# Muestra de manera compacta la estructura interna de un objeto
...
### Matriz con gráficos de dispersión de las variables cuantitativas
...
pairs(~ height + weight + diastolic_blood_pressure+diastolic_blood_pressure + imc, data = cardio_clean,   # Variable names
      col = c("red", "cornflowerblue", "purple")[group],   # Change color by group
      pch = c(8, 18, 1)[group], 
      main = "Pairs Cardio",    # Title of the plot
...
### Calcula los coeficientes de correlación entre variables

```{r}
# solo para varialbes númericos
...
Vamos a ver con resúmenes tabulares y gráficos que comparan los índices de rendimiento de los modelos.
...
Realizamos ahora la regresion con varias variables
...
Puede consultar el proyecto en:
  ...
  * ### [CODE](https://github.com/zumaiaUOC/zumaiaUOC.github.io/tree/main/cod)      
